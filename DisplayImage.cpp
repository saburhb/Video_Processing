...
int main(int argc, char** argv )
{
    ...
    //String rpath("/home/sbaidya/Downloads/campus_frames/*.pgm");
    String rpath("/home/sbaidya/wrkshp/rcv10/*.pgm");
	...
	pedDetector.detectMultiScale(image, peds, 2.5, 3, 0 | CV_HAAR_SCALE_IMAGE, Size(20, 50), Size(250, 500));
	pedDetector.detectMultiScale(imgr, pedsr, 2.5, 3, 0 | CV_HAAR_SCALE_IMAGE, Size(20, 50), Size(250, 500));
